...
XMLVM_DEFINE_CLASS(java_io_InvalidObjectException, 11, XMLVM_ITABLE_SIZE_java_io_InvalidObjectException)
...
#define XMLVM_VTABLE_SIZE_java_io_InvalidObjectException 11
