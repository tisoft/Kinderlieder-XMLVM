...
void org_apache_harmony_nio_internal_LockManager_addLock___java_nio_channels_FileLock(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w25853aaab3b1b5)
    // Begin try
    XMLVM_CHECK_NPE(9)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w25853aaab3b1b5)
        XMLVM_CATCH_SPECIFIC(w25853aaab3b1b5,java_lang_Object,64)
    XMLVM_CATCH_END(w25853aaab3b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w25853aaab3b1b5)
    label17:;
    XMLVM_TRY_BEGIN(w25853aaab3b1b7)
    // Begin try
    XMLVM_CHECK_NPE(3)
    ...
    if (_r0.i != 0) { XMLVM_MEMCPY(curThread_w25853aaab3b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w25853aaab3b1b7, sizeof(XMLVM_JMP_BUF)); goto label30; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w25853aaab3b1b7)
        XMLVM_CATCH_SPECIFIC(w25853aaab3b1b7,java_lang_Object,64)
    XMLVM_CATCH_END(w25853aaab3b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w25853aaab3b1b7)
    label23:;
    XMLVM_TRY_BEGIN(w25853aaab3b1b9)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w25853aaab3b1b9)
        XMLVM_CATCH_SPECIFIC(w25853aaab3b1b9,java_lang_Object,64)
    XMLVM_CATCH_END(w25853aaab3b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w25853aaab3b1b9)
    XMLVM_SOURCE_POSITION("LockManager.java", 71)
    java_lang_Object_releaseLockRecursive__(_r8.o);
    XMLVM_EXIT_METHOD()
    return;
    label30:;
    XMLVM_TRY_BEGIN(w25853aaab3b1c14)
    // Begin try
    ...
    if (_r4.i > 0) { XMLVM_MEMCPY(curThread_w25853aaab3b1c14->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w25853aaab3b1c14, sizeof(XMLVM_JMP_BUF)); goto label23; };
    ...
    if (_r0.i == 0) { XMLVM_MEMCPY(curThread_w25853aaab3b1c14->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w25853aaab3b1c14, sizeof(XMLVM_JMP_BUF)); goto label17; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w25853aaab3b1c14)
        XMLVM_CATCH_SPECIFIC(w25853aaab3b1c14,java_lang_Object,64)
    XMLVM_CATCH_END(w25853aaab3b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w25853aaab3b1c14)
    label64:;
    java_lang_Thread* curThread_w25853aaab3b1c16 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w25853aaab3b1c16->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r8.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void org_apache_harmony_nio_internal_LockManager_removeLock___java_nio_channels_FileLock(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w25853aaab4b1b5)
    // Begin try
    XMLVM_CHECK_NPE(1)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w25853aaab4b1b5)
        XMLVM_CATCH_SPECIFIC(w25853aaab4b1b5,java_lang_Object,8)
    XMLVM_CATCH_END(w25853aaab4b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w25853aaab4b1b5)
    XMLVM_SOURCE_POSITION("LockManager.java", 79)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return;
    label8:;
    java_lang_Thread* curThread_w25853aaab4b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w25853aaab4b1c10->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
