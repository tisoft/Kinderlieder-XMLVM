...
void my_kinderlieder_CollectionInfo___INIT____java_lang_String(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w20890aaab3b1c15)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w20890aaab3b1c15)
        XMLVM_CATCH_SPECIFIC(w20890aaab3b1c15,java_io_FileNotFoundException,23)
        XMLVM_CATCH_SPECIFIC(w20890aaab3b1c15,java_io_UnsupportedEncodingException,30)
    XMLVM_CATCH_END(w20890aaab3b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w20890aaab3b1c15)
    XMLVM_SOURCE_POSITION("CollectionInfo.java", 29)
    XMLVM_EXIT_METHOD()
    return;
    label23:;
    XMLVM_SOURCE_POSITION("CollectionInfo.java", 24)
    java_lang_Thread* curThread_w20890aaab3b1c20 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w20890aaab3b1c20->fields.java_lang_Thread.xmlvmException_;
    ...
    java_lang_Thread* curThread_w20890aaab3b1c27 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w20890aaab3b1c27->fields.java_lang_Thread.xmlvmException_;
