...
XMLVM_DEFINE_CLASS(java_io_InvalidClassException, 11, XMLVM_ITABLE_SIZE_java_io_InvalidClassException)
...
#define XMLVM_VTABLE_SIZE_java_io_InvalidClassException 11
