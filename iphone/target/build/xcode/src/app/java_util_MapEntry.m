...
JAVA_OBJECT java_util_MapEntry_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r1;
    _r1.o = me;
    XMLVM_TRY_BEGIN(w23484aaab4b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23484aaab4b1b2)
        XMLVM_CATCH_SPECIFIC(w23484aaab4b1b2,java_lang_CloneNotSupportedException,5)
    XMLVM_CATCH_END(w23484aaab4b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w23484aaab4b1b2)
    label4:;
    XMLVM_SOURCE_POSITION("MapEntry.java", 46)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label5:;
    java_lang_Thread* curThread_w23484aaab4b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w23484aaab4b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label4;
    //XMLVM_END_WRAPPER
}
