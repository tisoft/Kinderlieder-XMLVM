...
XMLVM_DEFINE_CLASS(java_io_InterruptedIOException, 11, XMLVM_ITABLE_SIZE_java_io_InterruptedIOException)
...
#define XMLVM_VTABLE_SIZE_java_io_InterruptedIOException 11
