...
JAVA_OBJECT java_util_IdentityHashMap_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r6;
    _r6.o = me;
    XMLVM_TRY_BEGIN(w35595aaac33b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35595aaac33b1b2)
        XMLVM_CATCH_SPECIFIC(w35595aaac33b1b2,java_lang_CloneNotSupportedException,28)
    XMLVM_CATCH_END(w35595aaac33b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w35595aaac33b1b2)
    label27:;
    XMLVM_SOURCE_POSITION("IdentityHashMap.java", 761)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label28:;
    java_lang_Thread* curThread_w35595aaac33b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w35595aaac33b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label27;
    //XMLVM_END_WRAPPER
}
