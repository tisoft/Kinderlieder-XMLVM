...
XMLVM_DEFINE_CLASS(java_io_ObjectStreamException, 11, XMLVM_ITABLE_SIZE_java_io_ObjectStreamException)
...
#define XMLVM_VTABLE_SIZE_java_io_ObjectStreamException 11
