...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_comparator__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w11295aaab4b1b5)
    // Begin try
    ...
    XMLVM_MEMCPY(curThread_w11295aaab4b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab4b1b5, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab4b1b5)
        XMLVM_CATCH_SPECIFIC(w11295aaab4b1b5,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab4b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab4b1b5)
    label11:;
    XMLVM_TRY_BEGIN(w11295aaab4b1b7)
    // Begin try
    java_lang_Thread* curThread_w11295aaab4b1b7aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab4b1b7aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab4b1b7)
        XMLVM_CATCH_SPECIFIC(w11295aaab4b1b7,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab4b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab4b1b7)
...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_firstKey__(JAVA_OBJECT me)
{
    ...
    _r0.o = ((java_util_Collections_SynchronizedMap*) _r2.o)->fields.java_util_Collections_SynchronizedMap.mutex_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaab5b1b5)
    // Begin try
    ...
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_MEMCPY(curThread_w11295aaab5b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab5b1b5, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab5b1b5)
        XMLVM_CATCH_SPECIFIC(w11295aaab5b1b5,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab5b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab5b1b5)
    label11:;
    XMLVM_TRY_BEGIN(w11295aaab5b1b7)
    // Begin try
    java_lang_Thread* curThread_w11295aaab5b1b7aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab5b1b7aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab5b1b7)
        XMLVM_CATCH_SPECIFIC(w11295aaab5b1b7,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab5b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab5b1b7)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_headMap___java_lang_Object(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaab6b1b6)
    // Begin try
    ...
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_MEMCPY(curThread_w11295aaab6b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab6b1b6, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab6b1b6)
        XMLVM_CATCH_SPECIFIC(w11295aaab6b1b6,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab6b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab6b1b6)
    label18:;
    XMLVM_TRY_BEGIN(w11295aaab6b1b8)
    // Begin try
    java_lang_Thread* curThread_w11295aaab6b1b8aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab6b1b8aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab6b1b8)
        XMLVM_CATCH_SPECIFIC(w11295aaab6b1b8,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab6b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab6b1b8)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_lastKey__(JAVA_OBJECT me)
{
    ...
    _r0.o = ((java_util_Collections_SynchronizedMap*) _r2.o)->fields.java_util_Collections_SynchronizedMap.mutex_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaab7b1b5)
    // Begin try
    ...
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_MEMCPY(curThread_w11295aaab7b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab7b1b5, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab7b1b5)
        XMLVM_CATCH_SPECIFIC(w11295aaab7b1b5,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab7b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab7b1b5)
    label11:;
    XMLVM_TRY_BEGIN(w11295aaab7b1b7)
    // Begin try
    java_lang_Thread* curThread_w11295aaab7b1b7aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab7b1b7aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab7b1b7)
        XMLVM_CATCH_SPECIFIC(w11295aaab7b1b7,java_lang_Object,11)
    XMLVM_CATCH_END(w11295aaab7b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab7b1b7)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_subMap___java_lang_Object_java_lang_Object(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    _r0.o = ((java_util_Collections_SynchronizedMap*) _r4.o)->fields.java_util_Collections_SynchronizedMap.mutex_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaab8b1b7)
    // Begin try
    ...
    java_util_Collections_SynchronizedSortedMap___INIT____java_util_SortedMap_java_lang_Object(_r1.o, _r2.o, _r3.o);
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_MEMCPY(curThread_w11295aaab8b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab8b1b7, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab8b1b7)
        XMLVM_CATCH_SPECIFIC(w11295aaab8b1b7,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab8b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab8b1b7)
    label18:;
    XMLVM_TRY_BEGIN(w11295aaab8b1b9)
    // Begin try
    java_lang_Thread* curThread_w11295aaab8b1b9aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab8b1b9aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab8b1b9)
        XMLVM_CATCH_SPECIFIC(w11295aaab8b1b9,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab8b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab8b1b9)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_util_Collections_SynchronizedSortedMap_tailMap___java_lang_Object(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    _r0.o = ((java_util_Collections_SynchronizedMap*) _r4.o)->fields.java_util_Collections_SynchronizedMap.mutex_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaab9b1b6)
    // Begin try
    ...
    java_util_Collections_SynchronizedSortedMap___INIT____java_util_SortedMap_java_lang_Object(_r1.o, _r2.o, _r3.o);
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_MEMCPY(curThread_w11295aaab9b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaab9b1b6, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab9b1b6)
        XMLVM_CATCH_SPECIFIC(w11295aaab9b1b6,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab9b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab9b1b6)
    label18:;
    XMLVM_TRY_BEGIN(w11295aaab9b1b8)
    // Begin try
    java_lang_Thread* curThread_w11295aaab9b1b8aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaab9b1b8aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaab9b1b8)
        XMLVM_CATCH_SPECIFIC(w11295aaab9b1b8,java_lang_Object,18)
    XMLVM_CATCH_END(w11295aaab9b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaab9b1b8)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
void java_util_Collections_SynchronizedSortedMap_writeObject___java_io_ObjectOutputStream(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    _r0.o = ((java_util_Collections_SynchronizedMap*) _r2.o)->fields.java_util_Collections_SynchronizedMap.mutex_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w11295aaac10b1b6)
    // Begin try
    ...
    XMLVM_MEMCPY(curThread_w11295aaac10b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w11295aaac10b1b6, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaac10b1b6)
        XMLVM_CATCH_SPECIFIC(w11295aaac10b1b6,java_lang_Object,8)
    XMLVM_CATCH_END(w11295aaac10b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaac10b1b6)
    label8:;
    XMLVM_TRY_BEGIN(w11295aaac10b1b8)
    // Begin try
    java_lang_Thread* curThread_w11295aaac10b1b8aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w11295aaac10b1b8aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w11295aaac10b1b8)
        XMLVM_CATCH_SPECIFIC(w11295aaac10b1b8,java_lang_Object,8)
    XMLVM_CATCH_END(w11295aaac10b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w11295aaac10b1b8)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
