...
void java_io_FilterOutputStream_close__(JAVA_OBJECT me)
{
    ...
    _r0.o = JAVA_NULL;
    XMLVM_TRY_BEGIN(w44266aaab2b1b4)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44266aaab2b1b4)
        XMLVM_CATCH_SPECIFIC(w44266aaab2b1b4,java_lang_Throwable,20)
    XMLVM_CATCH_END(w44266aaab2b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w44266aaab2b1b4)
    label4:;
    XMLVM_TRY_BEGIN(w44266aaab2b1b6)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44266aaab2b1b6)
        XMLVM_CATCH_SPECIFIC(w44266aaab2b1b6,java_lang_Throwable,15)
    XMLVM_CATCH_END(w44266aaab2b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w44266aaab2b1b6)
    label9:;
    ...
    java_lang_Thread* curThread_w44266aaab2b1c17 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w44266aaab2b1c17->fields.java_lang_Thread.xmlvmException_;
    ...
    java_lang_Thread* curThread_w44266aaab2b1c25 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w44266aaab2b1c25->fields.java_lang_Thread.xmlvmException_;
    goto label4;
    //XMLVM_END_WRAPPER
}
