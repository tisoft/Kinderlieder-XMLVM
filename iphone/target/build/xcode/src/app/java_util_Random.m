...
JAVA_INT java_util_Random_next___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    XMLVM_TRY_BEGIN(w34843aaab7b1b5)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w34843aaab7b1b5)
        XMLVM_CATCH_SPECIFIC(w34843aaab7b1b5,java_lang_Object,29)
    XMLVM_CATCH_END(w34843aaab7b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w34843aaab7b1b5)
    _r2.i = 48;
    _r2.i = _r2.i - _r5.i;
    ...
    return _r0.i;
    label29:;
    java_lang_Thread* curThread_w34843aaab7b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w34843aaab7b1c13->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r4.o);
...
JAVA_DOUBLE java_util_Random_nextGaussian__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w34843aaac12b1b6)
    // Begin try
    _r0.i = ((java_util_Random*) _r12.o)->fields.java_util_Random.haveNextNextGaussian_;
    if (_r0.i == 0) { XMLVM_MEMCPY(curThread_w34843aaac12b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w34843aaac12b1b6, sizeof(XMLVM_JMP_BUF)); goto label16; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w34843aaac12b1b6)
        XMLVM_CATCH_SPECIFIC(w34843aaac12b1b6,java_lang_Object,58)
    XMLVM_CATCH_END(w34843aaac12b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w34843aaac12b1b6)
    label14:;
    ...
    return _r0.d;
    label16:;
    XMLVM_TRY_BEGIN(w34843aaac12b1c12)
    // Begin try
    ...
    if (_r6.i >= 0) { XMLVM_MEMCPY(curThread_w34843aaac12b1c12->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w34843aaac12b1c12, sizeof(XMLVM_JMP_BUF)); goto label16; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w34843aaac12b1c12)
        XMLVM_CATCH_SPECIFIC(w34843aaac12b1c12,java_lang_Object,58)
    XMLVM_CATCH_END(w34843aaac12b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w34843aaac12b1c12)
    _r0.d = _r0.d * _r4.d;
    goto label14;
    label58:;
    java_lang_Thread* curThread_w34843aaac12b1c16 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w34843aaac12b1c16->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r12.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_util_Random_setSeed___long(JAVA_OBJECT me, JAVA_LONG n1)
{
    ...
    _r2.l = 281474976710655;
    _r0.l = _r0.l & _r2.l;
    XMLVM_TRY_BEGIN(w34843aaac16b1b9)
    // Begin try
    ((java_util_Random*) _r4.o)->fields.java_util_Random.seed_ = _r0.l;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w34843aaac16b1b9)
        XMLVM_CATCH_SPECIFIC(w34843aaac16b1b9,java_lang_Object,20)
    XMLVM_CATCH_END(w34843aaac16b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w34843aaac16b1b9)
    XMLVM_SOURCE_POSITION("Random.java", 252)
    java_lang_Object_releaseLockRecursive__(_r4.o);
    XMLVM_EXIT_METHOD()
    return;
    label20:;
    java_lang_Thread* curThread_w34843aaac16b1c14 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w34843aaac16b1c14->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r4.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
