...
void java_io_FilterInputStream_mark___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    XMLVM_TRY_BEGIN(w18571aaab4b1b5)
    // Begin try
    XMLVM_CHECK_NPE(1)
    _r0.o = ((java_io_FilterInputStream*) _r1.o)->fields.java_io_FilterInputStream.in_;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w18571aaab4b1b5)
        XMLVM_CATCH_SPECIFIC(w18571aaab4b1b5,java_lang_Object,8)
    XMLVM_CATCH_END(w18571aaab4b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w18571aaab4b1b5)
    XMLVM_SOURCE_POSITION("FilterInputStream.java", 90)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return;
    label8:;
    java_lang_Thread* curThread_w18571aaab4b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w18571aaab4b1c10->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
...
void java_io_FilterInputStream_reset__(JAVA_OBJECT me)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r1.o);
    XMLVM_TRY_BEGIN(w18571aaab9b1b4)
    // Begin try
    XMLVM_CHECK_NPE(1)
    _r0.o = ((java_io_FilterInputStream*) _r1.o)->fields.java_io_FilterInputStream.in_;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w18571aaab9b1b4)
        XMLVM_CATCH_SPECIFIC(w18571aaab9b1b4,java_lang_Object,8)
    XMLVM_CATCH_END(w18571aaab9b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w18571aaab9b1b4)
    XMLVM_SOURCE_POSITION("FilterInputStream.java", 179)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return;
    label8:;
    java_lang_Thread* curThread_w18571aaab9b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w18571aaab9b1b9->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
