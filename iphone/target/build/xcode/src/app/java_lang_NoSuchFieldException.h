...
XMLVM_DEFINE_CLASS(java_lang_NoSuchFieldException, 11, XMLVM_ITABLE_SIZE_java_lang_NoSuchFieldException)
...
#define XMLVM_VTABLE_SIZE_java_lang_NoSuchFieldException 11
