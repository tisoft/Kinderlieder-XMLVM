...
JAVA_OBJECT gnu_xml_dom_ls_DomLSInput_getStringData__(JAVA_OBJECT me)
{
    ...
    _r2.i = 4096;
    XMLVM_TRY_BEGIN(w13733aaac11b1b9)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w13733aaac11b1b9)
        XMLVM_CATCH_SPECIFIC(w13733aaac11b1b9,java_io_IOException,34)
    XMLVM_CATCH_END(w13733aaac11b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w13733aaac11b1b9)
    label17:;
    _r4.i = -1;
    ...
    _r4.i = 0;
    XMLVM_TRY_BEGIN(w13733aaac11b1c20)
    // Begin try
    XMLVM_CHECK_NPE(0)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w13733aaac11b1c20)
        XMLVM_CATCH_SPECIFIC(w13733aaac11b1c20,java_io_IOException,34)
    XMLVM_CATCH_END(w13733aaac11b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w13733aaac11b1c20)
    goto label17;
    label34:;
    XMLVM_SOURCE_POSITION("DomLSInput.java", 99)
    java_lang_Thread* curThread_w13733aaac11b1c24 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w13733aaac11b1c24->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label24;
    //XMLVM_END_WRAPPER
}
