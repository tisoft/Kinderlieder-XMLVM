...
void java_util_zip_ZipEntry___INIT____java_util_zip_ZipEntry_LittleEndianReader_java_io_InputStream(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    label353:;
    XMLVM_TRY_BEGIN(w14551aaac34b1d237)
    // Begin try
    ...
    if (_r0.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w14551aaac34b1d237->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14551aaac34b1d237, sizeof(XMLVM_JMP_BUF)); goto label374; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14551aaac34b1d237)
        XMLVM_CATCH_SPECIFIC(w14551aaac34b1d237,java_io_UnsupportedEncodingException,378)
    XMLVM_CATCH_END(w14551aaac34b1d237)
    XMLVM_RESTORE_EXCEPTION_ENV(w14551aaac34b1d237)
    label373:;
    XMLVM_TRY_BEGIN(w14551aaac34b1d239)
    // Begin try
    XMLVM_SOURCE_POSITION("ZipEntry.java", 421)
    XMLVM_MEMCPY(curThread_w14551aaac34b1d239->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14551aaac34b1d239, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14551aaac34b1d239)
        XMLVM_CATCH_SPECIFIC(w14551aaac34b1d239,java_io_UnsupportedEncodingException,378)
    XMLVM_CATCH_END(w14551aaac34b1d239)
    XMLVM_RESTORE_EXCEPTION_ENV(w14551aaac34b1d239)
    label374:;
    XMLVM_TRY_BEGIN(w14551aaac34b1d241)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14551aaac34b1d241)
        XMLVM_CATCH_SPECIFIC(w14551aaac34b1d241,java_io_UnsupportedEncodingException,378)
    XMLVM_CATCH_END(w14551aaac34b1d241)
    XMLVM_RESTORE_EXCEPTION_ENV(w14551aaac34b1d241)
    goto label373;
    label378:;
    XMLVM_SOURCE_POSITION("ZipEntry.java", 418)
    java_lang_Thread* curThread_w14551aaac34b1d245 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14551aaac34b1d245->fields.java_lang_Thread.xmlvmException_;
...
JAVA_LONG java_util_zip_ZipEntry_readIntLE___java_io_RandomAccessFile(JAVA_OBJECT n1)
{
    ...
    _r0.o = __NEW_java_io_EOFException();
    // "archive.3B"
    _r1.o = xmlvm_create_java_string_from_pool(1069);
    _r1.o = org_apache_harmony_archive_internal_nls_Messages_getString___java_lang_String(_r1.o);
    XMLVM_CHECK_NPE(0)
