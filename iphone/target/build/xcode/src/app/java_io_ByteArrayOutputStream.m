...
void java_io_ByteArrayOutputStream_reset__(JAVA_OBJECT me)
{
    ...
    _r0.i = 0;
    XMLVM_TRY_BEGIN(w14749aaab6b1b5)
    // Begin try
    ((java_io_ByteArrayOutputStream*) _r1.o)->fields.java_io_ByteArrayOutputStream.count_ = _r0.i;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaab6b1b5)
        XMLVM_CATCH_SPECIFIC(w14749aaab6b1b5,java_lang_Object,6)
    XMLVM_CATCH_END(w14749aaab6b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaab6b1b5)
    XMLVM_SOURCE_POSITION("ByteArrayOutputStream.java", 105)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return;
    label6:;
    java_lang_Thread* curThread_w14749aaab6b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14749aaab6b1c10->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_io_ByteArrayOutputStream_toByteArray__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w14749aaab8b1b4)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaab8b1b4)
        XMLVM_CATCH_SPECIFIC(w14749aaab8b1b4,java_lang_Object,16)
    XMLVM_CATCH_END(w14749aaab8b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaab8b1b4)
    XMLVM_SOURCE_POSITION("ByteArrayOutputStream.java", 126)
    java_lang_Object_releaseLockRecursive__(_r5.o);
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label16:;
    java_lang_Thread* curThread_w14749aaab8b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14749aaab8b1b9->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r5.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_io_ByteArrayOutputStream_write___byte_1ARRAY_int_int(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_INT n2, JAVA_INT n3)
{
    ...
    XMLVM_TRY_BEGIN(w14749aaac12b1b8)
    // Begin try
    _r0.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r3.o));
    if (_r4.i > _r0.i) { XMLVM_MEMCPY(curThread_w14749aaac12b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14749aaac12b1b8, sizeof(XMLVM_JMP_BUF)); goto label12; };
    if (_r5.i < 0) { XMLVM_MEMCPY(curThread_w14749aaac12b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14749aaac12b1b8, sizeof(XMLVM_JMP_BUF)); goto label12; };
    XMLVM_SOURCE_POSITION("ByteArrayOutputStream.java", 201)
    _r0.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r3.o));
    _r0.i = _r0.i - _r4.i;
    if (_r5.i <= _r0.i) { XMLVM_MEMCPY(curThread_w14749aaac12b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14749aaac12b1b8, sizeof(XMLVM_JMP_BUF)); goto label27; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac12b1b8)
        XMLVM_CATCH_SPECIFIC(w14749aaac12b1b8,java_lang_Object,24)
    XMLVM_CATCH_END(w14749aaac12b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac12b1b8)
    label12:;
    XMLVM_TRY_BEGIN(w14749aaac12b1c10)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac12b1c10)
        XMLVM_CATCH_SPECIFIC(w14749aaac12b1c10,java_lang_Object,24)
    XMLVM_CATCH_END(w14749aaac12b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac12b1c10)
    label24:;
    java_lang_Thread* curThread_w14749aaac12b1c12 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14749aaac12b1c12->fields.java_lang_Thread.xmlvmException_;
    ...
    return;
    label31:;
    XMLVM_TRY_BEGIN(w14749aaac12b1c23)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac12b1c23)
        XMLVM_CATCH_SPECIFIC(w14749aaac12b1c23,java_lang_Object,24)
    XMLVM_CATCH_END(w14749aaac12b1c23)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac12b1c23)
    goto label29;
    //XMLVM_END_WRAPPER
}
...
void java_io_ByteArrayOutputStream_write___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    XMLVM_TRY_BEGIN(w14749aaac13b1b5)
    // Begin try
    ...
    _r1.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r1.o));
    if (_r0.i != _r1.i) { XMLVM_MEMCPY(curThread_w14749aaac13b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14749aaac13b1b5, sizeof(XMLVM_JMP_BUF)); goto label12; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac13b1b5)
        XMLVM_CATCH_SPECIFIC(w14749aaac13b1b5,java_lang_Object,25)
    XMLVM_CATCH_END(w14749aaac13b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac13b1b5)
    label12:;
    XMLVM_TRY_BEGIN(w14749aaac13b1b7)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac13b1b7)
        XMLVM_CATCH_SPECIFIC(w14749aaac13b1b7,java_lang_Object,25)
    XMLVM_CATCH_END(w14749aaac13b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac13b1b7)
    XMLVM_SOURCE_POSITION("ByteArrayOutputStream.java", 227)
    java_lang_Object_releaseLockRecursive__(_r3.o);
    XMLVM_EXIT_METHOD()
    return;
    label25:;
    java_lang_Thread* curThread_w14749aaac13b1c12 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14749aaac13b1c12->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_io_ByteArrayOutputStream_writeTo___java_io_OutputStream(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r3.o);
    XMLVM_TRY_BEGIN(w14749aaac14b1b5)
    // Begin try
    _r0.o = ((java_io_ByteArrayOutputStream*) _r3.o)->fields.java_io_ByteArrayOutputStream.buf_;
    _r1.i = 0;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14749aaac14b1b5)
        XMLVM_CATCH_SPECIFIC(w14749aaac14b1b5,java_lang_Object,11)
    XMLVM_CATCH_END(w14749aaac14b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w14749aaac14b1b5)
    XMLVM_SOURCE_POSITION("ByteArrayOutputStream.java", 240)
    java_lang_Object_releaseLockRecursive__(_r3.o);
    XMLVM_EXIT_METHOD()
    return;
    label11:;
    java_lang_Thread* curThread_w14749aaac14b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w14749aaac14b1c10->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
