...
XMLVM_DEFINE_CLASS(java_lang_NullPointerException, 11, XMLVM_ITABLE_SIZE_java_lang_NullPointerException)
...
#define XMLVM_VTABLE_SIZE_java_lang_NullPointerException 11
