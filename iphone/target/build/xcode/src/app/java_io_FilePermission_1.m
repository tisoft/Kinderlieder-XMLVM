...
JAVA_OBJECT java_io_FilePermission_1_run__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w26064aaab3b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w26064aaab3b1b2)
        XMLVM_CATCH_SPECIFIC(w26064aaab3b1b2,java_io_IOException,12)
    XMLVM_CATCH_END(w26064aaab3b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w26064aaab3b1b2)
    label11:;
    XMLVM_SOURCE_POSITION("FilePermission.java", 112)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label12:;
    java_lang_Thread* curThread_w26064aaab3b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w26064aaab3b1b7->fields.java_lang_Thread.xmlvmException_;
    XMLVM_CHECK_NPE(2)
