...
void java_net_InetSocketAddress___INIT____java_lang_String_int_boolean(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_INT n2, JAVA_BOOLEAN n3)
{
    ...
    XMLVM_TRY_BEGIN(w42756aaab8b1c27)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w42756aaab8b1c27)
        XMLVM_CATCH_SPECIFIC(w42756aaab8b1c27,java_net_UnknownHostException,40)
    XMLVM_CATCH_END(w42756aaab8b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w42756aaab8b1c27)
    label35:;
    ...
    java_lang_Thread* curThread_w42756aaab8b1c38 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w42756aaab8b1c38->fields.java_lang_Thread.xmlvmException_;
    goto label35;
    //XMLVM_END_WRAPPER
}
