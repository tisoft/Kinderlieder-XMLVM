...
JAVA_OBJECT org_apache_harmony_niochar_charset_UTF_8_Encoder_encodeLoop___java_nio_CharBuffer_java_nio_ByteBuffer(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    XMLVM_TRY_BEGIN(w23095aaab2b1d248)
    // Begin try
    XMLVM_SOURCE_POSITION("UTF_8.java", 325)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d248)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d248,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d248)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d248)
    ...
    goto label57;
    label341:;
    XMLVM_TRY_BEGIN(w23095aaab2b1d254)
    // Begin try
    ...
    _r3.i = _r3.i & _r4.i;
    _r4.i = 127;
    if (_r3.i > _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d254->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d254, sizeof(XMLVM_JMP_BUF)); goto label381; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 330)
    XMLVM_SOURCE_POSITION("UTF_8.java", 332)
    _r4.i = 1;
    if (_r1.i >= _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d254->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d254, sizeof(XMLVM_JMP_BUF)); goto label364; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 333)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d254)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d254,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d254)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d254)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    _r3.i = _r3.i & 255;
    _r3.i = (_r3.i << 24) >> 24;
    XMLVM_TRY_BEGIN(w23095aaab2b1d262)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d262)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d262,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d262)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d262)
    ...
    XMLVM_TRY_BEGIN(w23095aaab2b1d280)
    // Begin try
    XMLVM_SOURCE_POSITION("UTF_8.java", 341)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d280)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d280,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d280)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d280)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    _r4.i = _r4.i + 192;
    _r4.i = (_r4.i << 24) >> 24;
    XMLVM_TRY_BEGIN(w23095aaab2b1d290)
    // Begin try
    //java_nio_ByteBuffer_put___byte[51]
    XMLVM_CHECK_NPE(14)
    ...
    _r1.i = _r1.i + -2;
    { XMLVM_MEMCPY(curThread_w23095aaab2b1d290->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d290, sizeof(XMLVM_JMP_BUF)); goto label372; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 347)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d290)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d290,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d290)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d290)
    label417:;
    XMLVM_TRY_BEGIN(w23095aaab2b1d292)
    // Begin try
    _r4.i = 55296;
    if (_r3.i < _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d292->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d292, sizeof(XMLVM_JMP_BUF)); goto label541; };
    _r4.i = 57343;
    if (_r3.i > _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d292->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d292, sizeof(XMLVM_JMP_BUF)); goto label541; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 350)
    _r4.i = _r0.i + 1;
    if (_r2.i > _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d292->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d292, sizeof(XMLVM_JMP_BUF)); goto label439; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 351)
    _r1.o = java_nio_charset_CoderResult_GET_UNDERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d292)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d292,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d292)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d292)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    XMLVM_TRY_BEGIN(w23095aaab2b1d300)
    // Begin try
    XMLVM_SOURCE_POSITION("UTF_8.java", 355)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d300)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d300,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d300)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d300)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    _r1.i = 1;
    XMLVM_TRY_BEGIN(w23095aaab2b1d310)
    // Begin try
    _r1.o = java_nio_charset_CoderResult_malformedForLength___int(_r1.i);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d310)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d310,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d310)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d310)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    label466:;
    XMLVM_TRY_BEGIN(w23095aaab2b1d315)
    // Begin try
    ...
    _r4.i = _r4.i & _r5.i;
    _r5.i = 56320;
    if (_r4.i >= _r5.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d315->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d315, sizeof(XMLVM_JMP_BUF)); goto label490; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d315)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d315,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d315)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d315)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    _r4.i = _r4.i + 240;
    _r4.i = (_r4.i << 24) >> 24;
    XMLVM_TRY_BEGIN(w23095aaab2b1d329)
    // Begin try
    ...
    { XMLVM_MEMCPY(curThread_w23095aaab2b1d329->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d329, sizeof(XMLVM_JMP_BUF)); goto label372; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 386)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d329)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d329,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d329)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d329)
    label541:;
    XMLVM_TRY_BEGIN(w23095aaab2b1d331)
    // Begin try
    _r4.i = 3;
    if (_r1.i >= _r4.i) { XMLVM_MEMCPY(curThread_w23095aaab2b1d331->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w23095aaab2b1d331, sizeof(XMLVM_JMP_BUF)); goto label552; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 387)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d331)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d331,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d331)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d331)
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
    _r0 = _r1;
    goto label57;
    ...
    _r4.i = _r4.i + 224;
    _r4.i = (_r4.i << 24) >> 24;
    XMLVM_TRY_BEGIN(w23095aaab2b1d341)
    // Begin try
    //java_nio_ByteBuffer_put___byte[51]
    XMLVM_CHECK_NPE(14)
    (*(JAVA_OBJECT (*)(JAVA_OBJECT, JAVA_BYTE)) ((java_nio_ByteBuffer*) _r14.o)->tib->vtable[51])(_r14.o, _r4.i);
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w23095aaab2b1d341)
        XMLVM_CATCH_SPECIFIC(w23095aaab2b1d341,java_lang_Object,584)
    XMLVM_CATCH_END(w23095aaab2b1d341)
    XMLVM_RESTORE_EXCEPTION_ENV(w23095aaab2b1d341)
    XMLVM_SOURCE_POSITION("UTF_8.java", 392)
    _r1.i = _r1.i + -3;
    goto label372;
    label584:;
    XMLVM_SOURCE_POSITION("UTF_8.java", 396)
    java_lang_Thread* curThread_w23095aaab2b1d347 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w23095aaab2b1d347->fields.java_lang_Thread.xmlvmException_;
    XMLVM_CHECK_NPE(13)
    java_nio_Buffer_position___int(_r13.o, _r0.i);
