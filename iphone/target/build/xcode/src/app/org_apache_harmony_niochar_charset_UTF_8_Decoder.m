...
JAVA_OBJECT org_apache_harmony_niochar_charset_UTF_8_Decoder_decodeLoop___java_nio_ByteBuffer_java_nio_CharBuffer(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    XMLVM_TRY_BEGIN(w44322aaab2b1d161)
    // Begin try
    XMLVM_SOURCE_POSITION("UTF_8.java", 171)
    _r1.o = java_nio_charset_CoderResult_GET_OVERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d161)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d161,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d161)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d161)
    ...
    goto label81;
    label243:;
    XMLVM_TRY_BEGIN(w44322aaab2b1d167)
    // Begin try
    ...
    if (_r3.i >= 0) { XMLVM_MEMCPY(curThread_w44322aaab2b1d167->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44322aaab2b1d167, sizeof(XMLVM_JMP_BUF)); goto label383; };
    ...
    _r5.i = -1;
    if (_r4.i != _r5.i) { XMLVM_MEMCPY(curThread_w44322aaab2b1d167->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44322aaab2b1d167, sizeof(XMLVM_JMP_BUF)); goto label271; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 179)
    _r1.i = 1;
    _r1.o = java_nio_charset_CoderResult_malformedForLength___int(_r1.i);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d167)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d167,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d167)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d167)
    XMLVM_CHECK_NPE(14)
    java_nio_Buffer_position___int(_r14.o, _r0.i);
    _r0 = _r1;
    goto label81;
    ...
    XMLVM_TRY_BEGIN(w44322aaab2b1d176)
    // Begin try
    XMLVM_SOURCE_POSITION("UTF_8.java", 182)
    _r1.o = java_nio_charset_CoderResult_GET_UNDERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d176)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d176,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d176)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d176)
    XMLVM_CHECK_NPE(14)
    java_nio_Buffer_position___int(_r14.o, _r0.i);
    _r0 = _r1;
    goto label81;
    ...
    XMLVM_TRY_BEGIN(w44322aaab2b1d188)
    // Begin try
    ...
    if (_r3.i >= _r5.i) { XMLVM_MEMCPY(curThread_w44322aaab2b1d188->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44322aaab2b1d188, sizeof(XMLVM_JMP_BUF)); goto label348; };
    XMLVM_SOURCE_POSITION("UTF_8.java", 197)
    _r1.i = 1;
    _r1.o = java_nio_charset_CoderResult_malformedForLength___int(_r1.i);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d188)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d188,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d188)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d188)
    XMLVM_CHECK_NPE(14)
    java_nio_Buffer_position___int(_r14.o, _r0.i);
    _r0 = _r1;
    goto label81;
    label318:;
    XMLVM_TRY_BEGIN(w44322aaab2b1d193)
    // Begin try
    ...
    _r7.i = _r6.i & 192;
    _r8.i = 128;
    if (_r7.i == _r8.i) { XMLVM_MEMCPY(curThread_w44322aaab2b1d193->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44322aaab2b1d193, sizeof(XMLVM_JMP_BUF)); goto label342; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d193)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d193,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d193)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d193)
    XMLVM_CHECK_NPE(14)
    java_nio_Buffer_position___int(_r14.o, _r0.i);
    _r0 = _r1;
    ...
    _r3.i = _r3.i + 1;
    _r0.i = _r0.i & 0xffff;
    XMLVM_TRY_BEGIN(w44322aaab2b1d214)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d214)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d214,java_lang_Object,380)
    XMLVM_CATCH_END(w44322aaab2b1d214)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d214)
    ...
    XMLVM_TRY_BEGIN(w44322aaab2b1d222)
    // Begin try
    _r1.o = java_nio_charset_CoderResult_GET_UNDERFLOW();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44322aaab2b1d222)
        XMLVM_CATCH_SPECIFIC(w44322aaab2b1d222,java_lang_Object,372)
    XMLVM_CATCH_END(w44322aaab2b1d222)
    XMLVM_RESTORE_EXCEPTION_ENV(w44322aaab2b1d222)
    XMLVM_CHECK_NPE(14)
    java_nio_Buffer_position___int(_r14.o, _r0.i);
    _r0 = _r1;
    goto label81;
    ...
    java_lang_Thread* curThread_w44322aaab2b1d228 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w44322aaab2b1d228->fields.java_lang_Thread.xmlvmException_;
    _r12 = _r1;
    _r1 = _r0;
    _r0 = _r12;
    label376:;
    ...
    label380:;
    java_lang_Thread* curThread_w44322aaab2b1d237 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w44322aaab2b1d237->fields.java_lang_Thread.xmlvmException_;
    _r1 = _r3;
    goto label376;
    label383:;
    _r12 = _r3;
