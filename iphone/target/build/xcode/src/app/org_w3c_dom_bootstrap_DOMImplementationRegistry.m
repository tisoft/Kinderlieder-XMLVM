...
void __INIT_IMPL_org_w3c_dom_bootstrap_DOMImplementationRegistry()
{
    ...
    _STATIC_org_w3c_dom_bootstrap_DOMImplementationRegistry_PROPERTY = (java_lang_String*) xmlvm_create_java_string_from_pool(3369);
...
JAVA_OBJECT org_w3c_dom_bootstrap_DOMImplementationRegistry_getClassLoader__()
{
    ...
    XMLVM_TRY_BEGIN(w44530aaab8b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab8b1b2)
        XMLVM_CATCH_SPECIFIC(w44530aaab8b1b2,java_lang_Exception,10)
    XMLVM_CATCH_END(w44530aaab8b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab8b1b2)
    ...
    java_lang_Thread* curThread_w44530aaab8b1c12 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w44530aaab8b1c12->fields.java_lang_Thread.xmlvmException_;
...
JAVA_OBJECT org_w3c_dom_bootstrap_DOMImplementationRegistry_getServiceValue___java_lang_ClassLoader(JAVA_OBJECT n1)
{
    ...
    _r4.o = xmlvm_create_java_string_from_pool(3370);
    XMLVM_TRY_BEGIN(w44530aaab9b1b5)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab9b1b5)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1b5,java_lang_Exception,55)
    XMLVM_CATCH_END(w44530aaab9b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab9b1b5)
    if (_r2.o == JAVA_NULL) goto label59;
    XMLVM_TRY_BEGIN(w44530aaab9b1b7)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab9b1b7)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1b7,java_io_UnsupportedEncodingException,40)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1b7,java_lang_Exception,55)
    XMLVM_CATCH_END(w44530aaab9b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab9b1b7)
    label23:;
    XMLVM_TRY_BEGIN(w44530aaab9b1b9)
    // Begin try
    ...
    if (_r5.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w44530aaab9b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44530aaab9b1b9, sizeof(XMLVM_JMP_BUF)); goto label59; };
    //java_lang_String_length__[8]
    XMLVM_CHECK_NPE(5)
    _r6.i = (*(JAVA_INT (*)(JAVA_OBJECT)) ((java_lang_String*) _r5.o)->tib->vtable[8])(_r5.o);
    if (_r6.i <= 0) { XMLVM_MEMCPY(curThread_w44530aaab9b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44530aaab9b1b9, sizeof(XMLVM_JMP_BUF)); goto label59; };
    _r6 = _r5;
    XMLVM_SOURCE_POSITION("DOMImplementationRegistry.java", 250)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab9b1b9)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1b9,java_lang_Exception,55)
    XMLVM_CATCH_END(w44530aaab9b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab9b1b9)
    label39:;
    XMLVM_TRY_BEGIN(w44530aaab9b1c11)
    // Begin try
    XMLVM_SOURCE_POSITION("DOMImplementationRegistry.java", 256)
    XMLVM_MEMCPY(curThread_w44530aaab9b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44530aaab9b1c11, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r6.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab9b1c11)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1c11,java_lang_Exception,55)
    XMLVM_CATCH_END(w44530aaab9b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab9b1c11)
    label40:;
    XMLVM_TRY_BEGIN(w44530aaab9b1c13)
    // Begin try
    XMLVM_SOURCE_POSITION("DOMImplementationRegistry.java", 242)
    java_lang_Thread* curThread_w44530aaab9b1c13ab1 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r6.o = curThread_w44530aaab9b1c13ab1->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r6;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaab9b1c13)
        XMLVM_CATCH_SPECIFIC(w44530aaab9b1c13,java_lang_Exception,55)
    XMLVM_CATCH_END(w44530aaab9b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaab9b1c13)
    goto label23;
    label55:;
    XMLVM_SOURCE_POSITION("DOMImplementationRegistry.java", 253)
    java_lang_Thread* curThread_w44530aaab9b1c17 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r6.o = curThread_w44530aaab9b1c17->fields.java_lang_Thread.xmlvmException_;
    _r1 = _r6;
    _r6 = _r8;
...
JAVA_BOOLEAN org_w3c_dom_bootstrap_DOMImplementationRegistry_isJRE11__()
{
    ...
    XMLVMElem _r0;
    XMLVMElem _r1;
    XMLVM_TRY_BEGIN(w44530aaac10b1b1)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44530aaac10b1b1)
        XMLVM_CATCH_SPECIFIC(w44530aaac10b1b1,java_lang_Exception,8)
    XMLVM_CATCH_END(w44530aaac10b1b1)
    XMLVM_RESTORE_EXCEPTION_ENV(w44530aaac10b1b1)
    _r1.i = 0;
    label7:;
    ...
    java_lang_Thread* curThread_w44530aaac10b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w44530aaac10b1b9->fields.java_lang_Thread.xmlvmException_;
    _r1.i = 1;
    goto label7;
    //XMLVM_END_WRAPPER
}
