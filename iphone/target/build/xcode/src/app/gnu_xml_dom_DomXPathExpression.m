...
void gnu_xml_dom_DomXPathExpression___INIT____gnu_xml_dom_DomDocument_java_lang_String_org_w3c_dom_xpath_XPathNSResolver(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2, JAVA_OBJECT n3)
{
    ...
    label25:;
    XMLVM_TRY_BEGIN(w28146aaab3b1c22)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab3b1c22)
        XMLVM_CATCH_SPECIFIC(w28146aaab3b1c22,javax_xml_xpath_XPathExpressionException,32)
    XMLVM_CATCH_END(w28146aaab3b1c22)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab3b1c22)
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 92)
    XMLVM_EXIT_METHOD()
    return;
    label32:;
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 87)
    java_lang_Thread* curThread_w28146aaab3b1c27 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w28146aaab3b1c27->fields.java_lang_Thread.xmlvmException_;
...
JAVA_OBJECT gnu_xml_dom_DomXPathExpression_evaluate___org_w3c_dom_Node_short_java_lang_Object(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_SHORT n2, JAVA_OBJECT n3)
{
    ...
    XMLVM_TRY_BEGIN(w28146aaab4b1b9)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1b9)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1b9,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1b9)
    label14:;
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 136)
    java_lang_Thread* curThread_w28146aaab4b1c12 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w28146aaab4b1c12->fields.java_lang_Thread.xmlvmException_;
    ...
    XMLVM_THROW_CUSTOM(_r1.o)
    label25:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c19)
    // Begin try
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 103)
    _r0.o = javax_xml_xpath_XPathConstants_GET_BOOLEAN();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c19)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c19,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c19)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c19)
    label27:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c21)
    // Begin try
    ...
    switch (_r6.i) {
    case 5: { XMLVM_MEMCPY(curThread_w28146aaab4b1c21->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c21, sizeof(XMLVM_JMP_BUF)); goto label55; };
    case 7: { XMLVM_MEMCPY(curThread_w28146aaab4b1c21->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c21, sizeof(XMLVM_JMP_BUF)); goto label55; };
    }
    _r0 = _r4;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c21)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c21,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c21)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c21)
    label37:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c23)
    // Begin try
    ...
    XMLVM_MEMCPY(curThread_w28146aaab4b1c23->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c23, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c23)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c23,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c23)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c23)
    label43:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c25)
    // Begin try
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 106)
    _r0.o = javax_xml_xpath_XPathConstants_GET_NUMBER();
    { XMLVM_MEMCPY(curThread_w28146aaab4b1c25->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c25, sizeof(XMLVM_JMP_BUF)); goto label27; };
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 109)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c25)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c25,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c25)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c25)
    label46:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c27)
    // Begin try
    _r0.o = javax_xml_xpath_XPathConstants_GET_STRING();
    { XMLVM_MEMCPY(curThread_w28146aaab4b1c27->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c27, sizeof(XMLVM_JMP_BUF)); goto label27; };
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 113)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c27)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c27,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c27)
    label49:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c29)
    // Begin try
    _r0.o = javax_xml_xpath_XPathConstants_GET_NODE();
    { XMLVM_MEMCPY(curThread_w28146aaab4b1c29->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c29, sizeof(XMLVM_JMP_BUF)); goto label27; };
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 119)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c29)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c29,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c29)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c29)
    label52:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c31)
    // Begin try
    _r0.o = javax_xml_xpath_XPathConstants_GET_NODESET();
    { XMLVM_MEMCPY(curThread_w28146aaab4b1c31->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w28146aaab4b1c31, sizeof(XMLVM_JMP_BUF)); goto label27; };
    XMLVM_SOURCE_POSITION("DomXPathExpression.java", 130)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c31)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c31,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c31)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c31)
    label55:;
    XMLVM_TRY_BEGIN(w28146aaab4b1c33)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28146aaab4b1c33)
        XMLVM_CATCH_SPECIFIC(w28146aaab4b1c33,javax_xml_xpath_XPathException,14)
    XMLVM_CATCH_END(w28146aaab4b1c33)
    XMLVM_RESTORE_EXCEPTION_ENV(w28146aaab4b1c33)
    goto label37;
    label72:;
    label94:;
    //XMLVM_END_WRAPPER
...
JAVA_OBJECT gnu_xml_dom_DomXPathExpression_toString__(JAVA_OBJECT me)
{
    ...
    // "[expression="
    _r1.o = xmlvm_create_java_string_from_pool(2385);
    XMLVM_CHECK_NPE(0)
