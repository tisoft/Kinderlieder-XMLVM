...
JAVA_BOOLEAN gnu_xml_aelfred2_JAXPFactory_JaxpParser_isNamespaceAware__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w28508aaab7b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28508aaab7b1b2)
        XMLVM_CATCH_SPECIFIC(w28508aaab7b1b2,java_lang_Exception,9)
    XMLVM_CATCH_END(w28508aaab7b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w28508aaab7b1b2)
    XMLVM_EXIT_METHOD()
    return _r0.i;
    label9:;
    XMLVM_SOURCE_POSITION("JAXPFactory.java", 210)
    java_lang_Thread* curThread_w28508aaab7b1b6 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w28508aaab7b1b6->fields.java_lang_Thread.xmlvmException_;
...
JAVA_BOOLEAN gnu_xml_aelfred2_JAXPFactory_JaxpParser_isValidating__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w28508aaab8b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w28508aaab8b1b2)
        XMLVM_CATCH_SPECIFIC(w28508aaab8b1b2,java_lang_Exception,9)
    XMLVM_CATCH_END(w28508aaab8b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w28508aaab8b1b2)
    XMLVM_EXIT_METHOD()
    return _r0.i;
    label9:;
    XMLVM_SOURCE_POSITION("JAXPFactory.java", 222)
    java_lang_Thread* curThread_w28508aaab8b1b6 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w28508aaab8b1b6->fields.java_lang_Thread.xmlvmException_;
    _r0.o = __NEW_java_lang_Error();
    XMLVM_CHECK_NPE(0)
    java_lang_Error___INIT___(_r0.o);
    XMLVM_THROW_CUSTOM(_r0.o)
