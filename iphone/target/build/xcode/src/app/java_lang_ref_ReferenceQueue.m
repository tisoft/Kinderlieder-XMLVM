...
static XMLVM_FIELD_REFLECTION_DATA __field_reflection_data[] = {
    ...
    0,
    &_STATIC_java_lang_ref_ReferenceQueue_DEFAULT_QUEUE_SIZE,
    "",
    JAVA_NULL},
    {"references",
    &__CLASS_java_lang_ref_Reference_1ARRAY,
    0 | java_lang_reflect_Modifier_PRIVATE,
    XMLVM_OFFSETOF(java_lang_ref_ReferenceQueue, fields.java_lang_ref_ReferenceQueue.references_),
    0,
    "",
    JAVA_NULL},
    {"head",
    &__CLASS_int,
    0 | java_lang_reflect_Modifier_PRIVATE,
    XMLVM_OFFSETOF(java_lang_ref_ReferenceQueue, fields.java_lang_ref_ReferenceQueue.head_),
    0,
    "",
    JAVA_NULL},
    {"tail",
    &__CLASS_int,
    0 | java_lang_reflect_Modifier_PRIVATE,
    XMLVM_OFFSETOF(java_lang_ref_ReferenceQueue, fields.java_lang_ref_ReferenceQueue.tail_),
    0,
    "",
    JAVA_NULL},
    {"empty",
    &__CLASS_boolean,
    0 | java_lang_reflect_Modifier_PRIVATE,
    XMLVM_OFFSETOF(java_lang_ref_ReferenceQueue, fields.java_lang_ref_ReferenceQueue.empty_),
    0,
    "",
    JAVA_NULL},
};
...
{
    JAVA_OBJECT obj = __NEW_java_lang_ref_ReferenceQueue();
    java_lang_reflect_Constructor* c = (java_lang_reflect_Constructor*) constructor;
    org_xmlvm_runtime_XMLVMArray* args = (org_xmlvm_runtime_XMLVMArray*) arguments;
    JAVA_ARRAY_OBJECT* argsArray = (JAVA_ARRAY_OBJECT*) args->fields.org_xmlvm_runtime_XMLVMArray.array_;
    switch (c->fields.java_lang_reflect_Constructor.slot_) {
    case 0:
        java_lang_ref_ReferenceQueue___INIT___(obj);
        break;
    default:
...
static JAVA_OBJECT* __method4_arg_types[] = {
    &__CLASS_java_lang_ref_Reference,
};
...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) java_lang_ref_ReferenceQueue_newArray___int(receiver, ((java_lang_Integer*) argsArray[0])->fields.java_lang_Integer.value_);
        break;
    case 1:
        result = (JAVA_OBJECT) java_lang_ref_ReferenceQueue_poll__(receiver);
        break;
    case 2:
        result = (JAVA_OBJECT) java_lang_ref_ReferenceQueue_remove__(receiver);
        break;
    case 3:
        result = (JAVA_OBJECT) java_lang_ref_ReferenceQueue_remove___long(receiver, ((java_lang_Long*) argsArray[0])->fields.java_lang_Long.value_);
        break;
    case 4:
        conversion.i = (JAVA_BOOLEAN) java_lang_ref_ReferenceQueue_enqueue___java_lang_ref_Reference(receiver, argsArray[0]);
...
JAVA_OBJECT java_lang_ref_ReferenceQueue_poll__(JAVA_OBJECT me)
{
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1b4)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1b4,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1b4)
    label7:;
    XMLVM_TRY_BEGIN(w1317aaab7b1b6)
    // Begin try
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 78)
    XMLVM_MEMCPY(curThread_w1317aaab7b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1317aaab7b1b6, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1b6)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1b6,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1b6)
    label8:;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1b8)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1b8,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1b8)
    label31:;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1c10)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1c10,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1c10)
    label40:;
    XMLVM_TRY_BEGIN(w1317aaab7b1c12)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    { XMLVM_MEMCPY(curThread_w1317aaab7b1c12->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1317aaab7b1c12, sizeof(XMLVM_JMP_BUF)); goto label7; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1c12)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1c12,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1c12)
    label42:;
    XMLVM_TRY_BEGIN(w1317aaab7b1c14)
    // Begin try
    java_lang_Thread* curThread_w1317aaab7b1c14aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1317aaab7b1c14aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab7b1c14)
        XMLVM_CATCH_SPECIFIC(w1317aaab7b1c14,java_lang_Object,42)
    XMLVM_CATCH_END(w1317aaab7b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab7b1c14)
...
JAVA_OBJECT java_lang_ref_ReferenceQueue_remove___long(JAVA_OBJECT me, JAVA_LONG n1)
{
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c14)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c14,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c14)
    label26:;
    XMLVM_TRY_BEGIN(w1317aaab9b1c16)
    // Begin try
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 135)
    XMLVM_MEMCPY(curThread_w1317aaab9b1c16->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1317aaab9b1c16, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c16)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c16,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c16)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c16)
    label27:;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c18)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c18,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c18)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c18)
    label50:;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c20)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c20,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c20)
    label59:;
    XMLVM_TRY_BEGIN(w1317aaab9b1c22)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    { XMLVM_MEMCPY(curThread_w1317aaab9b1c22->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1317aaab9b1c22, sizeof(XMLVM_JMP_BUF)); goto label26; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c22)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c22,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c22)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c22)
    label61:;
    XMLVM_TRY_BEGIN(w1317aaab9b1c24)
    // Begin try
    java_lang_Thread* curThread_w1317aaab9b1c24aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1317aaab9b1c24aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c24)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c24,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c24)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c24)
    XMLVM_THROW_CUSTOM(_r0.o)
    label64:;
    XMLVM_TRY_BEGIN(w1317aaab9b1c27)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaab9b1c27)
        XMLVM_CATCH_SPECIFIC(w1317aaab9b1c27,java_lang_Object,61)
    XMLVM_CATCH_END(w1317aaab9b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaab9b1c27)
    goto label59;
    //XMLVM_END_WRAPPER
}
...
JAVA_BOOLEAN java_lang_ref_ReferenceQueue_enqueue___java_lang_ref_Reference(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaac10b1b5)
        XMLVM_CATCH_SPECIFIC(w1317aaac10b1b5,java_lang_Object,97)
    XMLVM_CATCH_END(w1317aaac10b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaac10b1b5)
    label58:;
    XMLVM_TRY_BEGIN(w1317aaac10b1b7)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaac10b1b7)
        XMLVM_CATCH_SPECIFIC(w1317aaac10b1b7,java_lang_Object,97)
    XMLVM_CATCH_END(w1317aaac10b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaac10b1b7)
    label68:;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaac10b1b9)
        XMLVM_CATCH_SPECIFIC(w1317aaac10b1b9,java_lang_Object,97)
    XMLVM_CATCH_END(w1317aaac10b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaac10b1b9)
    label88:;
    XMLVM_TRY_BEGIN(w1317aaac10b1c11)
    // Begin try
    ...
    _r0.i = 1;
    XMLVM_MEMCPY(curThread_w1317aaac10b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1317aaac10b1c11, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.i;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaac10b1c11)
        XMLVM_CATCH_SPECIFIC(w1317aaac10b1c11,java_lang_Object,97)
    XMLVM_CATCH_END(w1317aaac10b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaac10b1c11)
    label97:;
    XMLVM_TRY_BEGIN(w1317aaac10b1c13)
    // Begin try
    java_lang_Thread* curThread_w1317aaac10b1c13aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1317aaac10b1c13aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r6.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1317aaac10b1c13)
        XMLVM_CATCH_SPECIFIC(w1317aaac10b1c13,java_lang_Object,97)
    XMLVM_CATCH_END(w1317aaac10b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w1317aaac10b1c13)
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
