...
JAVA_OBJECT java_net_Authenticator_requestPasswordAuthentication___java_net_InetAddress_int_java_lang_String_java_lang_String_java_lang_String(JAVA_OBJECT n1, JAVA_INT n2, JAVA_OBJECT n3, JAVA_OBJECT n4, JAVA_OBJECT n5)
{
    ...
    XMLVM_TRY_BEGIN(w35138aaac19b1b9)
    // Begin try
    _r1.o = java_lang_System_getSecurityManager__();
    XMLVM_SOURCE_POSITION("Authenticator.java", 145)
    if (_r1.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w35138aaac19b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w35138aaac19b1b9, sizeof(XMLVM_JMP_BUF)); goto label14; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac19b1b9)
        XMLVM_CATCH_SPECIFIC(w35138aaac19b1b9,java_lang_Object,54)
    XMLVM_CATCH_END(w35138aaac19b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac19b1b9)
    label14:;
    XMLVM_TRY_BEGIN(w35138aaac19b1c11)
    // Begin try
    XMLVM_SOURCE_POSITION("Authenticator.java", 148)
    _r1.o = java_net_Authenticator_GET_thisAuthenticator();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac19b1c11)
        XMLVM_CATCH_SPECIFIC(w35138aaac19b1c11,java_lang_Object,54)
    XMLVM_CATCH_END(w35138aaac19b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac19b1c11)
    ...
    return _r1.o;
    label21:;
    XMLVM_TRY_BEGIN(w35138aaac19b1c20)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac19b1c20)
        XMLVM_CATCH_SPECIFIC(w35138aaac19b1c20,java_lang_Object,54)
    XMLVM_CATCH_END(w35138aaac19b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac19b1c20)
    goto label19;
    label54:;
    java_lang_Thread* curThread_w35138aaac19b1c23 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w35138aaac19b1c23->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
...
JAVA_OBJECT java_net_Authenticator_requestPasswordAuthentication___java_lang_String_java_net_InetAddress_int_java_lang_String_java_lang_String_java_lang_String(JAVA_OBJECT n1, JAVA_OBJECT n2, JAVA_INT n3, JAVA_OBJECT n4, JAVA_OBJECT n5, JAVA_OBJECT n6)
{
    ...
    _r0.o = __CLASS_java_net_Authenticator;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w35138aaac21b1c10)
    // Begin try
    _r1.o = java_lang_System_getSecurityManager__();
    XMLVM_SOURCE_POSITION("Authenticator.java", 212)
    if (_r1.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w35138aaac21b1c10->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w35138aaac21b1c10, sizeof(XMLVM_JMP_BUF)); goto label14; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac21b1c10)
        XMLVM_CATCH_SPECIFIC(w35138aaac21b1c10,java_lang_Object,58)
    XMLVM_CATCH_END(w35138aaac21b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac21b1c10)
    label14:;
    XMLVM_TRY_BEGIN(w35138aaac21b1c12)
    // Begin try
    XMLVM_SOURCE_POSITION("Authenticator.java", 215)
    _r1.o = java_net_Authenticator_GET_thisAuthenticator();
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac21b1c12)
        XMLVM_CATCH_SPECIFIC(w35138aaac21b1c12,java_lang_Object,58)
    XMLVM_CATCH_END(w35138aaac21b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac21b1c12)
    if (_r1.o != JAVA_NULL) goto label21;
    ...
    return _r1.o;
    label21:;
    XMLVM_TRY_BEGIN(w35138aaac21b1c21)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w35138aaac21b1c21)
        XMLVM_CATCH_SPECIFIC(w35138aaac21b1c21,java_lang_Object,58)
    XMLVM_CATCH_END(w35138aaac21b1c21)
    XMLVM_RESTORE_EXCEPTION_ENV(w35138aaac21b1c21)
    goto label19;
    label58:;
    java_lang_Thread* curThread_w35138aaac21b1c24 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w35138aaac21b1c24->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
