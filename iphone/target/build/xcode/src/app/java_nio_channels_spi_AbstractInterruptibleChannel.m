...
void java_nio_channels_spi_AbstractInterruptibleChannel___CLINIT_()
{
    ...
    XMLVM_TRY_BEGIN(w40409aaab3b1b4)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab3b1b4)
        XMLVM_CATCH_SPECIFIC(w40409aaab3b1b4,java_security_PrivilegedActionException,23)
    XMLVM_CATCH_END(w40409aaab3b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab3b1b4)
    label22:;
    XMLVM_SOURCE_POSITION("AbstractInterruptibleChannel.java", 40)
    XMLVM_EXIT_METHOD()
    return;
    label23:;
    java_lang_Thread* curThread_w40409aaab3b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w40409aaab3b1b9->fields.java_lang_Thread.xmlvmException_;
    goto label22;
    //XMLVM_END_WRAPPER
}
...
JAVA_BOOLEAN java_nio_channels_spi_AbstractInterruptibleChannel_isOpen__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w40409aaab5b1b4)
    // Begin try
    XMLVM_CHECK_NPE(1)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab5b1b4)
        XMLVM_CATCH_SPECIFIC(w40409aaab5b1b4,java_lang_Object,10)
    XMLVM_CATCH_END(w40409aaab5b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab5b1b4)
    ...
    goto label6;
    label10:;
    java_lang_Thread* curThread_w40409aaab5b1c14 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w40409aaab5b1c14->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
...
void java_nio_channels_spi_AbstractInterruptibleChannel_close__(JAVA_OBJECT me)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r1.o);
    XMLVM_TRY_BEGIN(w40409aaab6b1b7)
    // Begin try
    XMLVM_SOURCE_POSITION("AbstractInterruptibleChannel.java", 105)
    XMLVM_CHECK_NPE(1)
    _r0.i = ((java_nio_channels_spi_AbstractInterruptibleChannel*) _r1.o)->fields.java_nio_channels_spi_AbstractInterruptibleChannel.closed_;
    if (_r0.i != 0) { XMLVM_MEMCPY(curThread_w40409aaab6b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w40409aaab6b1b7, sizeof(XMLVM_JMP_BUF)); goto label15; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab6b1b7)
        XMLVM_CATCH_SPECIFIC(w40409aaab6b1b7,java_lang_Object,17)
    XMLVM_CATCH_END(w40409aaab6b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab6b1b7)
    label15:;
    XMLVM_TRY_BEGIN(w40409aaab6b1b9)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r1.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab6b1b9)
        XMLVM_CATCH_SPECIFIC(w40409aaab6b1b9,java_lang_Object,17)
    XMLVM_CATCH_END(w40409aaab6b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab6b1b9)
    label16:;
    XMLVM_TRY_BEGIN(w40409aaab6b1c11)
    // Begin try
    XMLVM_SOURCE_POSITION("AbstractInterruptibleChannel.java", 111)
    XMLVM_MEMCPY(curThread_w40409aaab6b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w40409aaab6b1c11, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab6b1c11)
        XMLVM_CATCH_SPECIFIC(w40409aaab6b1c11,java_lang_Object,17)
    XMLVM_CATCH_END(w40409aaab6b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab6b1c11)
    label17:;
    XMLVM_TRY_BEGIN(w40409aaab6b1c13)
    // Begin try
    java_lang_Thread* curThread_w40409aaab6b1c13aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w40409aaab6b1c13aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab6b1c13)
        XMLVM_CATCH_SPECIFIC(w40409aaab6b1c13,java_lang_Object,17)
    XMLVM_CATCH_END(w40409aaab6b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab6b1c13)
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_nio_channels_spi_AbstractInterruptibleChannel_begin__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w40409aaab7b1b5)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab7b1b5)
        XMLVM_CATCH_SPECIFIC(w40409aaab7b1b5,java_lang_Exception,25)
    XMLVM_CATCH_END(w40409aaab7b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab7b1b5)
    label24:;
    ...
    java_lang_Thread* curThread_w40409aaab7b1c11 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w40409aaab7b1c11->fields.java_lang_Thread.xmlvmException_;
...
void java_nio_channels_spi_AbstractInterruptibleChannel_end___boolean(JAVA_OBJECT me, JAVA_BOOLEAN n1)
{
    ...
    XMLVM_TRY_BEGIN(w40409aaab8b1b6)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40409aaab8b1b6)
        XMLVM_CATCH_SPECIFIC(w40409aaab8b1b6,java_lang_Exception,29)
    XMLVM_CATCH_END(w40409aaab8b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w40409aaab8b1b6)
    ...
    java_lang_Thread* curThread_w40409aaab8b1c19 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w40409aaab8b1c19->fields.java_lang_Thread.xmlvmException_;
