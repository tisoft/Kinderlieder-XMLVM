...
XMLVM_DEFINE_CLASS(java_net_UnknownHostException, 11, XMLVM_ITABLE_SIZE_java_net_UnknownHostException)
...
#define XMLVM_VTABLE_SIZE_java_net_UnknownHostException 11
