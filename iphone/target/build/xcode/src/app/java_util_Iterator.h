...
#define XMLVM_ITABLE_IDX_java_util_Iterator_hasNext__ 2
#define XMLVM_ITABLE_IDX_java_util_Iterator_next__ 3
#define XMLVM_ITABLE_IDX_java_util_Iterator_remove__ 4
