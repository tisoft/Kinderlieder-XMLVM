...
void my_kinderlieder_ShopDetailViewController_2_run__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r4;
    _r4.o = me;
    XMLVM_TRY_BEGIN(w18554aaab3b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w18554aaab3b1b2)
        XMLVM_CATCH_SPECIFIC(w18554aaab3b1b2,java_io_IOException,11)
    XMLVM_CATCH_END(w18554aaab3b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w18554aaab3b1b2)
    label10:;
    ...
    java_lang_Thread* curThread_w18554aaab3b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w18554aaab3b1b8->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r1;
