...
JAVA_INT java_io_FileInputStream_available__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w45572aaab8b1b7)
    // Begin try
    ...
    if (_r1.o != _r2.o) { XMLVM_MEMCPY(curThread_w45572aaab8b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab8b1b7, sizeof(XMLVM_JMP_BUF)); goto label22; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab8b1b7)
        XMLVM_CATCH_SPECIFIC(w45572aaab8b1b7,java_lang_Object,36)
    XMLVM_CATCH_END(w45572aaab8b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab8b1b7)
    label21:;
    XMLVM_TRY_BEGIN(w45572aaab8b1b9)
    // Begin try
    XMLVM_SOURCE_POSITION("FileInputStream.java", 151)
    XMLVM_MEMCPY(curThread_w45572aaab8b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab8b1b9, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.i;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab8b1b9)
        XMLVM_CATCH_SPECIFIC(w45572aaab8b1b9,java_lang_Object,36)
    XMLVM_CATCH_END(w45572aaab8b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab8b1b9)
    label22:;
    XMLVM_TRY_BEGIN(w45572aaab8b1c11)
    // Begin try
    _r1.o = ((java_io_FileInputStream*) _r4.o)->fields.java_io_FileInputStream.fileSystem_;
    ...
    java_lang_Object_releaseLockRecursive__(_r0.o);
    _r0 = _r1;
    { XMLVM_MEMCPY(curThread_w45572aaab8b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab8b1c11, sizeof(XMLVM_JMP_BUF)); goto label21; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab8b1c11)
        XMLVM_CATCH_SPECIFIC(w45572aaab8b1c11,java_lang_Object,36)
    XMLVM_CATCH_END(w45572aaab8b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab8b1c11)
    label36:;
    XMLVM_TRY_BEGIN(w45572aaab8b1c13)
    // Begin try
    java_lang_Thread* curThread_w45572aaab8b1c13aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w45572aaab8b1c13aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab8b1c13)
        XMLVM_CATCH_SPECIFIC(w45572aaab8b1c13,java_lang_Object,36)
    XMLVM_CATCH_END(w45572aaab8b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab8b1c13)
...
void java_io_FileInputStream_close__(JAVA_OBJECT me)
{
    ...
    _r0.o = ((java_io_FileInputStream*) _r4.o)->fields.java_io_FileInputStream.channel_;
    java_lang_Object_acquireLockRecursive__(_r0.o);
    XMLVM_TRY_BEGIN(w45572aaab9b1c15)
    // Begin try
    ...
    if (_r1.i == 0) { XMLVM_MEMCPY(curThread_w45572aaab9b1c15->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab9b1c15, sizeof(XMLVM_JMP_BUF)); goto label25; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c15)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c15,java_lang_Object,61)
    XMLVM_CATCH_END(w45572aaab9b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c15)
    label25:;
    XMLVM_TRY_BEGIN(w45572aaab9b1c17)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c17)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c17,java_lang_Object,61)
    XMLVM_CATCH_END(w45572aaab9b1c17)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c17)
    label26:;
    XMLVM_SOURCE_POSITION("FileInputStream.java", 175)
    java_lang_Object_acquireLockRecursive__(_r4.o);
    XMLVM_TRY_BEGIN(w45572aaab9b1c21)
    // Begin try
    ...
    if (_r0.i < 0) { XMLVM_MEMCPY(curThread_w45572aaab9b1c21->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab9b1c21, sizeof(XMLVM_JMP_BUF)); goto label56; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c21)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c21,java_lang_Object,58)
    XMLVM_CATCH_END(w45572aaab9b1c21)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c21)
    label56:;
    XMLVM_TRY_BEGIN(w45572aaab9b1c23)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r4.o);
    { XMLVM_MEMCPY(curThread_w45572aaab9b1c23->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaab9b1c23, sizeof(XMLVM_JMP_BUF)); goto label4; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c23)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c23,java_lang_Object,58)
    XMLVM_CATCH_END(w45572aaab9b1c23)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c23)
    label58:;
    XMLVM_TRY_BEGIN(w45572aaab9b1c25)
    // Begin try
    java_lang_Thread* curThread_w45572aaab9b1c25aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w45572aaab9b1c25aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r4.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c25)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c25,java_lang_Object,58)
    XMLVM_CATCH_END(w45572aaab9b1c25)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c25)
    XMLVM_THROW_CUSTOM(_r0.o)
    label61:;
    java_lang_Thread* curThread_w45572aaab9b1c28 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w45572aaab9b1c28->fields.java_lang_Thread.xmlvmException_;
    XMLVM_TRY_BEGIN(w45572aaab9b1c29)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaab9b1c29)
        XMLVM_CATCH_SPECIFIC(w45572aaab9b1c29,java_lang_Object,61)
    XMLVM_CATCH_END(w45572aaab9b1c29)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaab9b1c29)
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
...
JAVA_INT java_io_FileInputStream_read___byte_1ARRAY_int_int(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_INT n2, JAVA_INT n3)
{
    ...
    XMLVM_TRY_BEGIN(w45572aaac15b1c30)
    // Begin try
    ...
    if (_r0.o != _r1.o) { XMLVM_MEMCPY(curThread_w45572aaac15b1c30->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaac15b1c30, sizeof(XMLVM_JMP_BUF)); goto label42; };
    ...
    { XMLVM_MEMCPY(curThread_w45572aaac15b1c30->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaac15b1c30, sizeof(XMLVM_JMP_BUF)); goto label17; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac15b1c30)
        XMLVM_CATCH_SPECIFIC(w45572aaac15b1c30,java_lang_Object,39)
    XMLVM_CATCH_END(w45572aaac15b1c30)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac15b1c30)
    label39:;
    XMLVM_TRY_BEGIN(w45572aaac15b1c32)
    // Begin try
    java_lang_Thread* curThread_w45572aaac15b1c32aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w45572aaac15b1c32aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r6.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac15b1c32)
        XMLVM_CATCH_SPECIFIC(w45572aaac15b1c32,java_lang_Object,39)
    XMLVM_CATCH_END(w45572aaac15b1c32)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac15b1c32)
    XMLVM_THROW_CUSTOM(_r0.o)
    label42:;
    XMLVM_TRY_BEGIN(w45572aaac15b1c35)
    // Begin try
    _r0.o = ((java_io_FileInputStream*) _r7.o)->fields.java_io_FileInputStream.fileSystem_;
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac15b1c35)
        XMLVM_CATCH_SPECIFIC(w45572aaac15b1c35,java_lang_Object,39)
    XMLVM_CATCH_END(w45572aaac15b1c35)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac15b1c35)
    goto label17;
    //XMLVM_END_WRAPPER
}
...
JAVA_LONG java_io_FileInputStream_skip___long(JAVA_OBJECT me, JAVA_LONG n1)
{
    ...
    // "luni.AC"
    _r1.o = xmlvm_create_java_string_from_pool(3399);
    _r1.o = org_apache_harmony_luni_internal_nls_Messages_getString___java_lang_String(_r1.o);
    XMLVM_CHECK_NPE(0)
    ...
    java_lang_Object_acquireLockRecursive__(_r6.o);
    XMLVM_TRY_BEGIN(w45572aaac16b1c72)
    // Begin try
    ...
    _r0.l = _r0.l - _r7.l;
    java_lang_Object_releaseLockRecursive__(_r6.o);
    { XMLVM_MEMCPY(curThread_w45572aaac16b1c72->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaac16b1c72, sizeof(XMLVM_JMP_BUF)); goto label10; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac16b1c72)
        XMLVM_CATCH_SPECIFIC(w45572aaac16b1c72,java_lang_Object,106)
    XMLVM_CATCH_END(w45572aaac16b1c72)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac16b1c72)
    label106:;
    XMLVM_TRY_BEGIN(w45572aaac16b1c74)
    // Begin try
    java_lang_Thread* curThread_w45572aaac16b1c74aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w45572aaac16b1c74aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r6.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac16b1c74)
        XMLVM_CATCH_SPECIFIC(w45572aaac16b1c74,java_lang_Object,106)
    XMLVM_CATCH_END(w45572aaac16b1c74)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac16b1c74)
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_io_FileInputStream_openCheck__(JAVA_OBJECT me)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r4.o);
    XMLVM_TRY_BEGIN(w45572aaac17b1b4)
    // Begin try
    _r0.o = ((java_io_FileInputStream*) _r4.o)->fields.java_io_FileInputStream.fd_;
    _r0.l = ((java_io_FileDescriptor*) _r0.o)->fields.java_io_FileDescriptor.descriptor_;
    _r2.l = 0;
    _r0.i = _r0.l > _r2.l ? 1 : (_r0.l == _r2.l ? 0 : -1);
    if (_r0.i >= 0) { XMLVM_MEMCPY(curThread_w45572aaac17b1b4->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w45572aaac17b1b4, sizeof(XMLVM_JMP_BUF)); goto label20; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w45572aaac17b1b4)
        XMLVM_CATCH_SPECIFIC(w45572aaac17b1b4,java_lang_Object,17)
    XMLVM_CATCH_END(w45572aaac17b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w45572aaac17b1b4)
    label17:;
    java_lang_Thread* curThread_w45572aaac17b1b6 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w45572aaac17b1b6->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r4.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    label20:;
