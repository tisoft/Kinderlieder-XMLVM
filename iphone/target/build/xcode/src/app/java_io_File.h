...
XMLVM_FORWARD_DECL(org_apache_harmony_luni_internal_io_FileCanonPathCache)
#endif
...
XMLVM_FORWARD_DECL(org_apache_harmony_luni_util_DeleteOnExit)
#endif
