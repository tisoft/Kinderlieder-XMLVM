...
JAVA_OBJECT gnu_xml_xpath_Expr_ExprNodeSet_item___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    _r2.o = me;
    _r3.i = n1;
    XMLVM_TRY_BEGIN(w40102aaab3b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w40102aaab3b1b3)
        XMLVM_CATCH_SPECIFIC(w40102aaab3b1b3,java_lang_ArrayIndexOutOfBoundsException,10)
    XMLVM_CATCH_END(w40102aaab3b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w40102aaab3b1b3)
    _r1 = _r2;
    label9:;
    ...
    java_lang_Thread* curThread_w40102aaab3b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w40102aaab3b1c10->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r1;
    _r1.o = JAVA_NULL;
    goto label9;
    //XMLVM_END_WRAPPER
