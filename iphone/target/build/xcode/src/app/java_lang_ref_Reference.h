...
XMLVM_DEFINE_CLASS(java_lang_ref_Reference, 7, XMLVM_ITABLE_SIZE_java_lang_ref_Reference)
...
#define XMLVM_VTABLE_SIZE_java_lang_ref_Reference 7
#define XMLVM_VTABLE_IDX_java_lang_ref_Reference_get__ 6
