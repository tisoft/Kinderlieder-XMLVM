...
JAVA_OBJECT java_util_Vector_1_nextElement__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w14735aaab4b1b5)
    // Begin try
    ...
    if (_r1.i >= _r2.i) { XMLVM_MEMCPY(curThread_w14735aaab4b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14735aaab4b1b5, sizeof(XMLVM_JMP_BUF)); goto label25; };
    ...
    XMLVM_MEMCPY(curThread_w14735aaab4b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w14735aaab4b1b5, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r1.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14735aaab4b1b5)
        XMLVM_CATCH_SPECIFIC(w14735aaab4b1b5,java_lang_Object,32)
    XMLVM_CATCH_END(w14735aaab4b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w14735aaab4b1b5)
    label25:;
    XMLVM_TRY_BEGIN(w14735aaab4b1b7)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14735aaab4b1b7)
        XMLVM_CATCH_SPECIFIC(w14735aaab4b1b7,java_lang_Object,32)
    XMLVM_CATCH_END(w14735aaab4b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w14735aaab4b1b7)
    ...
    label32:;
    java_lang_Thread* curThread_w14735aaab4b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w14735aaab4b1c13->fields.java_lang_Thread.xmlvmException_;
    XMLVM_TRY_BEGIN(w14735aaab4b1c14)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w14735aaab4b1c14)
        XMLVM_CATCH_SPECIFIC(w14735aaab4b1c14,java_lang_Object,32)
    XMLVM_CATCH_END(w14735aaab4b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w14735aaab4b1c14)
