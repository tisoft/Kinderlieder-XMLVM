...
void __INIT_IMPL_java_util_ServiceLoader_ServiceIterator()
{
    ...
    _STATIC_java_util_ServiceLoader_ServiceIterator_SINGAL_SHARP = (java_lang_String*) xmlvm_create_java_string_from_pool(2472);
...
JAVA_OBJECT java_util_ServiceLoader_ServiceIterator_next__(JAVA_OBJECT me)
{
    ...
    _r0.o = _r0.o;
    XMLVM_TRY_BEGIN(w31229aaac10b1c14)
    // Begin try
    ...
    if (_r1.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w31229aaac10b1c14->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac10b1c14, sizeof(XMLVM_JMP_BUF)); goto label39; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac10b1c14)
        XMLVM_CATCH_SPECIFIC(w31229aaac10b1c14,java_lang_Exception,56)
    XMLVM_CATCH_END(w31229aaac10b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac10b1c14)
    label38:;
    XMLVM_TRY_BEGIN(w31229aaac10b1c16)
    // Begin try
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 197)
    XMLVM_MEMCPY(curThread_w31229aaac10b1c16->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac10b1c16, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac10b1c16)
        XMLVM_CATCH_SPECIFIC(w31229aaac10b1c16,java_lang_Exception,56)
    XMLVM_CATCH_END(w31229aaac10b1c16)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac10b1c16)
    label39:;
    XMLVM_TRY_BEGIN(w31229aaac10b1c18)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac10b1c18)
        XMLVM_CATCH_SPECIFIC(w31229aaac10b1c18,java_lang_Exception,56)
    XMLVM_CATCH_END(w31229aaac10b1c18)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac10b1c18)
    goto label38;
    label56:;
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 198)
    java_lang_Thread* curThread_w31229aaac10b1c22 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w31229aaac10b1c22->fields.java_lang_Thread.xmlvmException_;
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 200)
    _r2.o = __NEW_java_util_ServiceConfigurationError();
    // "KB005"
    _r3.o = xmlvm_create_java_string_from_pool(2473);
...
void java_util_ServiceLoader_ServiceIterator_readClass__(JAVA_OBJECT me)
{
    ...
    _r7.i = 0;
    // "KB006"
    _r9.o = xmlvm_create_java_string_from_pool(2474);
    // "#"
    ...
    XMLVM_THROW_CUSTOM(_r0.o)
    label49:;
    XMLVM_TRY_BEGIN(w31229aaac11b1c40)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac11b1c40)
        XMLVM_CATCH_SPECIFIC(w31229aaac11b1c40,java_lang_Exception,131)
    XMLVM_CATCH_END(w31229aaac11b1c40)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac11b1c40)
    label67:;
    XMLVM_TRY_BEGIN(w31229aaac11b1c42)
    // Begin try
    ...
    if (_r2.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w31229aaac11b1c42->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c42, sizeof(XMLVM_JMP_BUF)); goto label26; };
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 229)
    XMLVM_CHECK_NPE(2)
    _r2.o = java_lang_String_trim__(_r2.o);
    // "#"
    _r3.o = xmlvm_create_java_string_from_pool(2472);
    XMLVM_CHECK_NPE(2)
    ...
    if (_r3.i == 0) { XMLVM_MEMCPY(curThread_w31229aaac11b1c42->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c42, sizeof(XMLVM_JMP_BUF)); goto label67; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac11b1c42)
        XMLVM_CATCH_SPECIFIC(w31229aaac11b1c42,java_lang_Exception,131)
    XMLVM_CATCH_END(w31229aaac11b1c42)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac11b1c42)
    label114:;
    XMLVM_TRY_BEGIN(w31229aaac11b1c44)
    // Begin try
    _r5.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r3.o));
    if (_r4.i < _r5.i) { XMLVM_MEMCPY(curThread_w31229aaac11b1c44->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c44, sizeof(XMLVM_JMP_BUF)); goto label144; };
    ...
    if (_r3.i != 0) { XMLVM_MEMCPY(curThread_w31229aaac11b1c44->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c44, sizeof(XMLVM_JMP_BUF)); goto label67; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac11b1c44)
        XMLVM_CATCH_SPECIFIC(w31229aaac11b1c44,java_lang_Exception,131)
    XMLVM_CATCH_END(w31229aaac11b1c44)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac11b1c44)
    goto label67;
    label131:;
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 253)
    java_lang_Thread* curThread_w31229aaac11b1c48 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w31229aaac11b1c48->fields.java_lang_Thread.xmlvmException_;
    XMLVM_SOURCE_POSITION("ServiceLoader.java", 255)
    _r2.o = __NEW_java_util_ServiceConfigurationError();
    // "KB006"
    _r3.o = xmlvm_create_java_string_from_pool(2474);
    ...
    XMLVM_THROW_CUSTOM(_r2.o)
    label144:;
    XMLVM_TRY_BEGIN(w31229aaac11b1c57)
    // Begin try
    ...
    if (_r5.i != 0) { XMLVM_MEMCPY(curThread_w31229aaac11b1c57->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c57, sizeof(XMLVM_JMP_BUF)); goto label172; };
    XMLVM_CHECK_NPE(3)
    XMLVM_CHECK_ARRAY_BOUNDS(_r3.o, _r4.i);
    _r5.i = ((JAVA_ARRAY_CHAR*) (((org_xmlvm_runtime_XMLVMArray*) _r3.o)->fields.org_xmlvm_runtime_XMLVMArray.array_))[_r4.i];
    _r6.i = 46;
    if (_r5.i == _r6.i) { XMLVM_MEMCPY(curThread_w31229aaac11b1c57->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w31229aaac11b1c57, sizeof(XMLVM_JMP_BUF)); goto label172; };
    ...
    // "KB006"
    _r2.o = xmlvm_create_java_string_from_pool(2474);
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w31229aaac11b1c57)
        XMLVM_CATCH_SPECIFIC(w31229aaac11b1c57,java_lang_Exception,131)
    XMLVM_CATCH_END(w31229aaac11b1c57)
    XMLVM_RESTORE_EXCEPTION_ENV(w31229aaac11b1c57)
    label172:;
    _r4.i = _r4.i + 1;
    goto label114;
    //XMLVM_END_WRAPPER
