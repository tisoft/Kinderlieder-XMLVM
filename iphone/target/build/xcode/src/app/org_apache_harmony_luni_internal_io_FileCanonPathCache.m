...
JAVA_OBJECT org_apache_harmony_luni_internal_io_FileCanonPathCache_get___java_lang_String(JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w17650aaab7b1b7)
    // Begin try
    ...
    if (_r0.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w17650aaab7b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab7b1b7, sizeof(XMLVM_JMP_BUF)); goto label20; };
    _r0 = _r5;
    XMLVM_SOURCE_POSITION("FileCanonPathCache.java", 77)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1b7)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1b7,java_lang_Object,17)
    XMLVM_CATCH_END(w17650aaab7b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1b7)
    label16:;
    XMLVM_TRY_BEGIN(w17650aaab7b1b9)
    // Begin try
    XMLVM_SOURCE_POSITION("FileCanonPathCache.java", 95)
    XMLVM_MEMCPY(curThread_w17650aaab7b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab7b1b9, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1b9)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1b9,java_lang_Object,17)
    XMLVM_CATCH_END(w17650aaab7b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1b9)
    label17:;
    XMLVM_TRY_BEGIN(w17650aaab7b1c11)
    // Begin try
    java_lang_Thread* curThread_w17650aaab7b1c11aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w17650aaab7b1c11aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1c11)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1c11,java_lang_Object,17)
    XMLVM_CATCH_END(w17650aaab7b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1c11)
    ...
    _r1.o = org_apache_harmony_luni_internal_io_FileCanonPathCache_GET_lock();
    java_lang_Object_acquireLockRecursive__(_r1.o);
    XMLVM_TRY_BEGIN(w17650aaab7b1c25)
    // Begin try
    ...
    XMLVM_CHECK_NPE(0)
    _r0.o = (*(JAVA_OBJECT (*)(JAVA_OBJECT, JAVA_OBJECT)) ((java_util_HashMap*) _r0.o)->tib->vtable[10])(_r0.o, _r6.o);
    if (_r0.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w17650aaab7b1c25->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab7b1c25, sizeof(XMLVM_JMP_BUF)); goto label63; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1c25)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1c25,java_lang_Object,66)
    XMLVM_CATCH_END(w17650aaab7b1c25)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1c25)
    label44:;
    XMLVM_TRY_BEGIN(w17650aaab7b1c27)
    // Begin try
    ...
    if (_r0.i == 0) { XMLVM_MEMCPY(curThread_w17650aaab7b1c27->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab7b1c27, sizeof(XMLVM_JMP_BUF)); goto label44; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1c27)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1c27,java_lang_Object,66)
    XMLVM_CATCH_END(w17650aaab7b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1c27)
    label63:;
    XMLVM_TRY_BEGIN(w17650aaab7b1c29)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r1.o);
    _r0 = _r5;
    XMLVM_SOURCE_POSITION("FileCanonPathCache.java", 92)
    { XMLVM_MEMCPY(curThread_w17650aaab7b1c29->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab7b1c29, sizeof(XMLVM_JMP_BUF)); goto label16; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1c29)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1c29,java_lang_Object,66)
    XMLVM_CATCH_END(w17650aaab7b1c29)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1c29)
    label66:;
    XMLVM_TRY_BEGIN(w17650aaab7b1c31)
    // Begin try
    java_lang_Thread* curThread_w17650aaab7b1c31aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w17650aaab7b1c31aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab7b1c31)
        XMLVM_CATCH_SPECIFIC(w17650aaab7b1c31,java_lang_Object,66)
    XMLVM_CATCH_END(w17650aaab7b1c31)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab7b1c31)
    XMLVM_THROW_CUSTOM(_r0.o)
    label69:;
    XMLVM_CHECK_NPE(0)
...
void org_apache_harmony_luni_internal_io_FileCanonPathCache_put___java_lang_String_java_lang_String(JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    XMLVM_TRY_BEGIN(w17650aaab8b1b9)
    // Begin try
    ...
    _r3.i = 256;
    if (_r0.i < _r3.i) { XMLVM_MEMCPY(curThread_w17650aaab8b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab8b1b9, sizeof(XMLVM_JMP_BUF)); goto label31; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab8b1b9)
        XMLVM_CATCH_SPECIFIC(w17650aaab8b1b9,java_lang_Object,43)
    XMLVM_CATCH_END(w17650aaab8b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab8b1b9)
    label31:;
    XMLVM_TRY_BEGIN(w17650aaab8b1c11)
    // Begin try
    ...
    XMLVM_MEMCPY(curThread_w17650aaab8b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab8b1c11, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab8b1c11)
        XMLVM_CATCH_SPECIFIC(w17650aaab8b1c11,java_lang_Object,43)
    XMLVM_CATCH_END(w17650aaab8b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab8b1c11)
    label43:;
    XMLVM_TRY_BEGIN(w17650aaab8b1c13)
    // Begin try
    java_lang_Thread* curThread_w17650aaab8b1c13aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w17650aaab8b1c13aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r2.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab8b1c13)
        XMLVM_CATCH_SPECIFIC(w17650aaab8b1c13,java_lang_Object,43)
    XMLVM_CATCH_END(w17650aaab8b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab8b1c13)
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void org_apache_harmony_luni_internal_io_FileCanonPathCache_clear__()
{
    ...
    XMLVM_TRY_BEGIN(w17650aaab9b1b4)
    // Begin try
    ...
    XMLVM_MEMCPY(curThread_w17650aaab9b1b4->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w17650aaab9b1b4, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab9b1b4)
        XMLVM_CATCH_SPECIFIC(w17650aaab9b1b4,java_lang_Object,15)
    XMLVM_CATCH_END(w17650aaab9b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab9b1b4)
    label15:;
    XMLVM_TRY_BEGIN(w17650aaab9b1b6)
    // Begin try
    java_lang_Thread* curThread_w17650aaab9b1b6aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w17650aaab9b1b6aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w17650aaab9b1b6)
        XMLVM_CATCH_SPECIFIC(w17650aaab9b1b6,java_lang_Object,15)
    XMLVM_CATCH_END(w17650aaab9b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w17650aaab9b1b6)
