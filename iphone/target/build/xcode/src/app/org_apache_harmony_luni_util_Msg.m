...
void org_apache_harmony_luni_util_Msg___CLINIT_()
{
    ...
    XMLVM_TRY_BEGIN(w46307aaab1b1b4)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w46307aaab1b1b4)
        XMLVM_CATCH_SPECIFIC(w46307aaab1b1b4,java_lang_Throwable,16)
    XMLVM_CATCH_END(w46307aaab1b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w46307aaab1b1b4)
    label15:;
    ...
    java_lang_Thread* curThread_w46307aaab1b1c10 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w46307aaab1b1c10->fields.java_lang_Thread.xmlvmException_;
...
JAVA_OBJECT org_apache_harmony_luni_util_Msg_getString___java_lang_String(JAVA_OBJECT n1)
{
    ...
    return _r0.o;
    label6:;
    XMLVM_TRY_BEGIN(w46307aaab3b1c11)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w46307aaab3b1c11)
        XMLVM_CATCH_SPECIFIC(w46307aaab3b1c11,java_util_MissingResourceException,13)
    XMLVM_CATCH_END(w46307aaab3b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w46307aaab3b1c11)
    goto label5;
    label13:;
    java_lang_Thread* curThread_w46307aaab3b1c14 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w46307aaab3b1c14->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r1;
    goto label5;
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT org_apache_harmony_luni_util_Msg_getString___java_lang_String_java_lang_Object_1ARRAY(JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    XMLVM_TRY_BEGIN(w46307aaab8b1b7)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w46307aaab8b1b7)
        XMLVM_CATCH_SPECIFIC(w46307aaab8b1b7,java_util_MissingResourceException,15)
    XMLVM_CATCH_END(w46307aaab8b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w46307aaab8b1b7)
    label10:;
    ...
    return _r0.o;
    label15:;
    java_lang_Thread* curThread_w46307aaab8b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w46307aaab8b1c13->fields.java_lang_Thread.xmlvmException_;
    label16:;
    _r0 = _r1;
    goto label10;
    //XMLVM_END_WRAPPER
