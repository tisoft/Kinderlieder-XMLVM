...
void org_apache_harmony_luni_internal_net_www_protocol_http_HttpConnectionManager_ConnectionPool_clear__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w44897aaab2b1b4)
    // Begin try
    XMLVM_CHECK_NPE(5)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab2b1b4)
        XMLVM_CATCH_SPECIFIC(w44897aaab2b1b4,java_lang_Object,43)
    XMLVM_CATCH_END(w44897aaab2b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab2b1b4)
    label11:;
    XMLVM_TRY_BEGIN(w44897aaab2b1b6)
    // Begin try
    XMLVM_CHECK_NPE(2)
    ...
    if (_r4.i == 0) { XMLVM_MEMCPY(curThread_w44897aaab2b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab2b1b6, sizeof(XMLVM_JMP_BUF)); goto label46; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab2b1b6)
        XMLVM_CATCH_SPECIFIC(w44897aaab2b1b6,java_lang_Object,43)
    XMLVM_CATCH_END(w44897aaab2b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab2b1b6)
    label27:;
    XMLVM_TRY_BEGIN(w44897aaab2b1b8)
    // Begin try
    XMLVM_CHECK_NPE(3)
    ...
    if (_r4.i == 0) { XMLVM_MEMCPY(curThread_w44897aaab2b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab2b1b8, sizeof(XMLVM_JMP_BUF)); goto label11; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab2b1b8)
        XMLVM_CATCH_SPECIFIC(w44897aaab2b1b8,java_lang_Object,43)
    XMLVM_CATCH_END(w44897aaab2b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab2b1b8)
    goto label27;
    label43:;
    java_lang_Thread* curThread_w44897aaab2b1c11 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r4.o = curThread_w44897aaab2b1c11->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r5.o);
    XMLVM_THROW_CUSTOM(_r4.o)
    label46:;
    XMLVM_TRY_BEGIN(w44897aaab2b1c15)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab2b1c15)
        XMLVM_CATCH_SPECIFIC(w44897aaab2b1c15,java_lang_Object,43)
    XMLVM_CATCH_END(w44897aaab2b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab2b1c15)
...
void org_apache_harmony_luni_internal_net_www_protocol_http_HttpConnectionManager_ConnectionPool_returnConnection___org_apache_harmony_luni_internal_net_www_protocol_http_HttpConnection(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w44897aaab3b1b5)
    // Begin try
    XMLVM_CHECK_NPE(5)
    ...
    if (_r2.i != 0) { XMLVM_MEMCPY(curThread_w44897aaab3b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab3b1b5, sizeof(XMLVM_JMP_BUF)); goto label69; };
    ...
    _r1.o = _r1.o;
    if (_r1.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w44897aaab3b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab3b1b5, sizeof(XMLVM_JMP_BUF)); goto label41; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab3b1b5)
        XMLVM_CATCH_SPECIFIC(w44897aaab3b1b5,java_lang_Object,66)
    XMLVM_CATCH_END(w44897aaab3b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab3b1b5)
    label41:;
    XMLVM_TRY_BEGIN(w44897aaab3b1b7)
    // Begin try
    ...
    if (_r2.i >= _r3.i) { XMLVM_MEMCPY(curThread_w44897aaab3b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab3b1b7, sizeof(XMLVM_JMP_BUF)); goto label62; };
    ...
    if (_r2.i != 0) { XMLVM_MEMCPY(curThread_w44897aaab3b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab3b1b7, sizeof(XMLVM_JMP_BUF)); goto label60; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab3b1b7)
        XMLVM_CATCH_SPECIFIC(w44897aaab3b1b7,java_lang_Object,66)
    XMLVM_CATCH_END(w44897aaab3b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab3b1b7)
    label60:;
    ...
    return;
    label62:;
    XMLVM_TRY_BEGIN(w44897aaab3b1c13)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab3b1c13)
        XMLVM_CATCH_SPECIFIC(w44897aaab3b1c13,java_lang_Object,66)
    XMLVM_CATCH_END(w44897aaab3b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab3b1c13)
    goto label60;
    label66:;
    java_lang_Thread* curThread_w44897aaab3b1c16 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r2.o = curThread_w44897aaab3b1c16->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r4.o);
    XMLVM_THROW_CUSTOM(_r2.o)
    label69:;
    XMLVM_TRY_BEGIN(w44897aaab3b1c20)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab3b1c20)
        XMLVM_CATCH_SPECIFIC(w44897aaab3b1c20,java_lang_Object,66)
    XMLVM_CATCH_END(w44897aaab3b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab3b1c20)
    goto label60;
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT org_apache_harmony_luni_internal_net_www_protocol_http_HttpConnectionManager_ConnectionPool_getHttpConnection___org_apache_harmony_luni_internal_net_www_protocol_http_HttpConfiguration_int(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_INT n2)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r5.o);
    XMLVM_TRY_BEGIN(w44897aaab4b1b6)
    // Begin try
    XMLVM_CHECK_NPE(5)
    ...
    if (_r3.i == 0) { XMLVM_MEMCPY(curThread_w44897aaab4b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1b6, sizeof(XMLVM_JMP_BUF)); goto label27; };
    if (_r1.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w44897aaab4b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1b6, sizeof(XMLVM_JMP_BUF)); goto label27; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1b6)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1b6,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1b6)
    label27:;
    XMLVM_TRY_BEGIN(w44897aaab4b1b8)
    // Begin try
    XMLVM_SOURCE_POSITION("HttpConnectionManager.java", 143)
    _r3.i = org_apache_harmony_luni_internal_net_www_protocol_http_HttpConnectionManager_access$100__();
    if (_r3.i == 0) { XMLVM_MEMCPY(curThread_w44897aaab4b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1b8, sizeof(XMLVM_JMP_BUF)); goto label39; };
    XMLVM_CHECK_NPE(1)
    _r3.i = (*(JAVA_BOOLEAN (*)(JAVA_OBJECT)) *(((java_lang_Object*)_r1.o)->tib->itableBegin)[XMLVM_ITABLE_IDX_java_util_List_isEmpty__])(_r1.o);
    if (_r3.i == 0) { XMLVM_MEMCPY(curThread_w44897aaab4b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1b8, sizeof(XMLVM_JMP_BUF)); goto label47; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1b8)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1b8,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1b8)
    label39:;
    XMLVM_TRY_BEGIN(w44897aaab4b1c10)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1c10)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1c10,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1c10)
    _r3 = _r0;
    label45:;
    ...
    _r3.i = 0;
    XMLVM_TRY_BEGIN(w44897aaab4b1c20)
    // Begin try
    XMLVM_CHECK_NPE(1)
    ...
    if (_r3.i != 0) { XMLVM_MEMCPY(curThread_w44897aaab4b1c20->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1c20, sizeof(XMLVM_JMP_BUF)); goto label95; };
    XMLVM_SOURCE_POSITION("HttpConnectionManager.java", 150)
    _r2.o = java_lang_System_getSecurityManager__();
    if (_r2.o == JAVA_NULL) { XMLVM_MEMCPY(curThread_w44897aaab4b1c20->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1c20, sizeof(XMLVM_JMP_BUF)); goto label93; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1c20)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1c20,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1c20)
    label93:;
    XMLVM_TRY_BEGIN(w44897aaab4b1c22)
    // Begin try
    _r3 = _r0;
    XMLVM_SOURCE_POSITION("HttpConnectionManager.java", 154)
    { XMLVM_MEMCPY(curThread_w44897aaab4b1c22->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w44897aaab4b1c22, sizeof(XMLVM_JMP_BUF)); goto label45; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1c22)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1c22,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1c22)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1c22)
    label95:;
    XMLVM_TRY_BEGIN(w44897aaab4b1c24)
    // Begin try
    XMLVM_CHECK_NPE(5)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w44897aaab4b1c24)
        XMLVM_CATCH_SPECIFIC(w44897aaab4b1c24,java_lang_Object,100)
    XMLVM_CATCH_END(w44897aaab4b1c24)
    XMLVM_RESTORE_EXCEPTION_ENV(w44897aaab4b1c24)
    goto label45;
    label100:;
    java_lang_Thread* curThread_w44897aaab4b1c27 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r3.o = curThread_w44897aaab4b1c27->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r5.o);
