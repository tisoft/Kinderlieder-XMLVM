...
XMLVM_DEFINE_CLASS(java_lang_IndexOutOfBoundsException, 11, XMLVM_ITABLE_SIZE_java_lang_IndexOutOfBoundsException)
...
#define XMLVM_VTABLE_SIZE_java_lang_IndexOutOfBoundsException 11
